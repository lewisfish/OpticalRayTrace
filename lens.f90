module lensMod
    ...
    subroutine plano_convex(pos, dir, D1, Lt, R, u, iseed)
        !need to adjust placment due to focal plane being in lens********************************
        use vector_class
    ...
    subroutine achromatic_doublet(pos, dir, D1, D2, R1, R2, R3, tc1, tc2, lensRadius, u, iseed,skip)
        ...
        integer, intent(INOUT) :: iseed, u
        real , intent(IN) :: D1, D2, R1, R2, R3, tc1, tc2, lensRadius
        type(vector), intent(INOUT) :: pos, dir
        ...
        !second sphere
        centre = vector(0., 0., D1 + D2 + tc1 - R2)
        ...
        !second sphere
        centre = vector(0., 0., D1 + D2 + tc1+tc2 - R3)
